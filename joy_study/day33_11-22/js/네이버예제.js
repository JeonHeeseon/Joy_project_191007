var oriMenu = ["dic","news","stock"
         ,"movie",	"music","gra","weather","rev","cloud",
      "post","dater","line","comic","memo","band","deal",
      "bookmark","softwear","smartboard","sports","series","audio",
      "office","webf","car","address","map","kin","cal",
      ,"book","infor","air","hotel",
       "modoo","my","pcgame","tvl","vline","kdic","edic","jdic","cdic",
       "godic","moredic","vibe","alpah","clover","whale","papgo"]; 
  ...
  /*  setInterval(함수,시간) : 
	...
	function ticker(selector, playTime){
		...
		.animate({'margin-top':height},playTime,
			...
			.appendTo(selector + ' ul') // 띄어쓰기는 자손의 의미이다.
			.removeAttr('style');
		});
	}
